...
import tele from './assets/images/telegram.gif';
  ...
  render() {
    return (
      <section>
        ...
        <img src={tele} alt="loading..." />

        <TelegramShareButton className="telegram" url='https://t.me/abhi_sharma27' children='React Node'/>
